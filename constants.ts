import { Player, AppStage, Persona, TicketOffer, AddOn, Match, HospitalityPackage } from './types';
...
export const MATCHES: Match[] = [
  { id: 'm1', opponent: 'Manchester City', stadium: 'Stamford Bridge', stadiumCode: 'SB', league: 'Barclays WSL', round: '14', date: 'SUN 24 MAR • 12:30', isBigGame: true, status: 'SELLING_FAST' },
  { id: 'm2', opponent: 'West Ham United', stadium: 'Kingsmeadow', stadiumCode: 'KM', league: 'Barclays WSL', round: '15', date: 'SAT 30 MAR • 15:00', isBigGame: false, status: 'AVAILABLE' },
  { id: 'm3', opponent: 'Arsenal', stadium: 'Stamford Bridge', stadiumCode: 'SB', league: 'Champion League', round: 'Semifinals', date: 'SUN 14 APR • 18:45', isBigGame: true, status: 'SOLD_OUT' },
  { id: 'm4', opponent: 'Brighton', stadium: 'Kingsmeadow', stadiumCode: 'KM', league: 'Barclays WSL', round: '16', date: 'SUN 21 APR • 14:00', isBigGame: false, status: 'AVAILABLE' },
  { id: 'm5', opponent: 'Liverpool', stadium: 'Stamford Bridge', stadiumCode: 'SB', league: 'Barclays WSL', round: '17', date: 'SUN 05 MAY • 14:30', isBigGame: false, status: 'AVAILABLE' }
];
...
export const OFFERS_BY_PERSONA: Record<string, TicketOffer[]> = {
  [Persona.DIE_HARD]: [
    {
      id: 'bridge-pass',
